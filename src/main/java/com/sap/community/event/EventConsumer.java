...
public class EventConsumer implements CommunityConstant {
    ...
    public void handlePublishMsg(ConsumerRecord record) {
        if(record == null || record.value() == null) {
            logger.error("empty");
            return;
        }
    ...
    public void handleDeleteMsg(ConsumerRecord record) {
        if(record == null || record.value() == null) {
            logger.error("empty");
            return;
        }
