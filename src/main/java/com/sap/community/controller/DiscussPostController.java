...
import com.sap.community.entity.*;
import com.sap.community.event.EventProducer;
import com.sap.community.service.CommentService;
import com.sap.community.service.DiscussPostService;
...
import java.util.*;
// 帖子：包括作者，点赞数量/状态，评论，回复
// 系统管理员才有：置顶，加精，删除权限。这里通过拦截器管理
@Controller
    ...
    public String getDiscussPost(@PathVariable("discussPostId") int discussPostId, Model model, Page page) {
        ...
        if(commentVoList != null) {
            for (Comment comment : commentList) {
                ...
                // 点赞数量
                likeCount = likeService.findEntityLikeCount(ENTITY_TYPE_COMMENT, comment.getUserId());
